...
public class TestFindByEmail {
	...
	public static void main(String[] args) throws Exception {
		BloodBankDAOImp ob= new BloodBankDAOImp();
		//BloodBankAppService obj = new BloodBankAppService();
		logger.info("Enter the Email tobe found : ");
		Scanner sc= new Scanner(System.in);
		
		
		String email=sc.next();
		//boolean active=sc.nextBoolean();
		//obj.updateBloodGroup(email, active);
		BloodGroup out =ob.findByEmail(email);
		logger.info(out);
		sc.close();
